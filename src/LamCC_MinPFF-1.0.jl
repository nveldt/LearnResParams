...
# This code uses the projection-based method for solving the LambdaCC LP relaxation.
...
function MinPFF_LamCC(A::SparseMatrixCSC{Float64,Int64},c::Vector{Int64},dweight::Bool,
    error::Float64 = 1e-6, left::Float64 = 0.001, right::Float64 = .999,GapTol::Float64=1e-3,ConTol::Float64=1e-3,gam::Float64=10.0)
...
# Compute the entire bowl-shaped curve for a single clustering,
# rather than running the careful bisecion-like method.
