...
#
# This code allows you to set different values for the locality parameter
# epsilon, which gives a little more freedom in the type of localized objective
# function we are learning resolution parameters for.
#
# This may require a deeper understanding on what the FlowSeed routine is doing.
# See https://arxiv.org/abs/1811.12280.
# A simpler example of using the localized parameter fitness function is given
# in Test_Flowseed_PFF.jl
