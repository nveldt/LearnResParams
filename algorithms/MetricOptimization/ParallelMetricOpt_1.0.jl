...
function Parallel_Dykstra_lamCC_TFA(A::SparseMatrixCSC{Float64,Int64},lam::Float64=0.5,
...
function Parallel_Dykstra_lamCC_dw(A::SparseMatrixCSC{Float64,Int64},lam::Float64=2.0,
...
function Parallel_Dykstra_CC_TFA(A::SparseMatrixCSC{Float64,Int64},W::Matrix{Float64},D::Matrix{Float64},GapTol::Float64=1e-5,ConTol::Float64=1e-5,
...
function report_progress_CCDykstra(A::SparseMatrixCSC{Float64,Int64},D::Matrix{Float64},E::Matrix{Float64},F::Matrix{Float64},W::Matrix{Float64},current_corrections::Int,
    ...
    gam::Float64,LPobjs::Vector{Float64},primals::Vector{Float64},duals::Vector{Float64},gaps::Vector{Float64},ConViolation::Vector{Float64},statusFrequency::Int64)
        ...
        # I'm hard-coding away the rounding check, which doesn't
        # seem to help for this problem. In the future it would be good to
